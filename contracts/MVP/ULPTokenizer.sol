...
/**
 * @title ULPTokenizer (Ujamaa Liquidity Provider Token)
 ...
 */
contract ULPTokenizer is ERC20, AccessControl, ReentrancyGuard {
    // =========================================================================
    // CONSTANTS
    // =========================================================================
    ...
    constructor(
        ...
        if (_identityRegistry == address(0)) {
            revert("ULPTokenizer: Zero identity registry");
        }
        if (_compliance == address(0)) {
            revert("ULPTokenizer: Zero compliance");
        }
    ...
    function mintTestULP(address to, uint256 amount) external {
        ...
        require(IDENTITY_REGISTRY.isVerified(to), "ULPTokenizer: Recipient not verified");
        _mint(to, amount);
    }
