# UAT vs UPT Token Comparison Guide

## Understanding UJAMAA Token Types

**Document Type:** Investor Education  
**Version:** 1.0  
**Date:** March 18, 2026  
**Author:** Aziz Da Silva - Lead Architect  
**Audience:** Investors, Financial Advisors, Family Offices
...
| Feature | UAT | UPT |
|---------|-----|-----|
| **Full Name** | Ujamaa Asset Token | Ujamaa Pool Token |
| **Symbol** | `UAT-XXX` | `UPT-XXX` |
| **What You Own** | Share in ONE asset | Share in MANY assets |
| **Diversification** | ❌ None (single asset) | ✅ Yes (multiple assets) |
| **Risk Level** | Higher (concentrated) | Lower (diversified) |
| **Expected Return** | 8-15% (varies by asset) | 8-12% APR (averaged) |
| **Minimum Investment** | Varies by asset | €1,000 (standard) |
| **Best For** | Sophisticated investors | Most investors |
...
│  │         ↓                                                  │ │
│  │  Your return depends on THIS ONE property                  │ │
│  └────────────────────────────────────────────────────────────┘ │
│                                                                  │
│  UPT (Ujamaa Pool Token)                                        │
│  ┌────────────────────────────────────────────────────────────┐ │
...
│  │  ← DIVERSIFIED POOL                                        │ │
│  │         ↓                                                  │ │
│  │  Your return is spread across 50+ factories                │ │
│  └────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
...
**Example:** If you buy `UPT-IND` and one factory has problems, the other 49+ factories continue performing.
...
| Token | Minimum | Typical Investment |
|-------|---------|-------------------|
...
### **Q: Can I hold both in the same wallet?**

**A:** Yes! Both UAT and UPT are ERC-3643 tokens and can be held in the same compatible wallet.

---

### **Q: Do both tokens have the same compliance requirements?**

**A:** Yes, both require:
- KYC verification (all investors)
- KYB for investments ≥€100,000
- Jurisdiction restrictions (OFAC/UN/EU/FATF)
- Accreditation for certain UAT offerings
...
| **Investor FAQ** | `docs/08_INVESTORS_ROOM/09_INVESTOR_FAQ.md` | General investor questions |
| **How Tokenization Works** | `docs/08_INVESTORS_ROOM/05_EDUCATIONAL/01_HOW_TOKENIZATION_WORKS.md` | Tokenization basics |

---

## **15. Contact**

**For questions about UAT vs UPT:**
...
**Document ID:** UJAMAA-INV-UAT-UPT-001  
**Classification:** Public (Investor Education)

---

*This document is for educational purposes only and does not constitute investment advice. Please consult with your financial advisor before making investment decisions.*
