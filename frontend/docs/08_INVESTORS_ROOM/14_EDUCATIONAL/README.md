...
This folder contains **educational materials** to help investors understand tokenization, ERC-3643, wallets, and the UJAMAA platform.
...
| # | Document | Purpose |
|---|----------|---------|
| 01 | [How Tokenization Works](01_HOW_TOKENIZATION_WORKS.md) | Basics |
...
### For New Investors
1. [How Tokenization Works](01_HOW_TOKENIZATION_WORKS.md)
2. [Understanding ERC-3643](02_UNDERSTANDING_ERC3643.md)
3. [Wallet Setup Guide](03_WALLET_SETUP_GUIDE.md)
4. [Investor FAQ](04_INVESTOR_FAQ.md)
