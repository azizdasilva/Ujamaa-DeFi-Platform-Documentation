...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ─── Top Bar ─── */}
      <header className="fixed top-0 left-16 right-0 h-[140px] bg-white border-b border-gray-200 z-30 flex items-center px-6 justify-between">
        {/* Left: Logo */}
        <div className="flex flex-col items-start gap-1">
          <img src="/assets/images/logo-transparent.png" alt="Ujamaa DeFi" className="h-[96px] w-auto" />
