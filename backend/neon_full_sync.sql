-- =============================================================================
-- COMPLETE NEON DATABASE SYNC - 100% Match with Local SQLite
-- =============================================================================
...
CREATE TABLE bank_transactions (
    ...
    account_id VARCHAR(50) REFERENCES bank_accounts(account_id),
...
CREATE TABLE investments (
    ...
    investor_id INTEGER REFERENCES investor_profiles(id) ON DELETE CASCADE,
    amount NUMERIC(26, 18) NOT NULL,
    shares NUMERIC(26, 18) NOT NULL,
    nav NUMERIC(26, 18) NOT NULL,
    ult_tokens NUMERIC(26, 18) DEFAULT 0,
...
CREATE TABLE ult_transactions (
    ...
    transaction_type VARCHAR(50) NOT NULL,
    amount NUMERIC(26, 18) NOT NULL,
    balance_before NUMERIC(26, 18) NOT NULL,
    balance_after NUMERIC(26, 18) NOT NULL,
    transaction_hash VARCHAR(66),
    block_number INTEGER,
    status VARCHAR DEFAULT 'PENDING',
    created_at TIMESTAMP DEFAULT NOW()
...
CREATE TABLE ulp_transactions (
    ...
    amount NUMERIC(26, 18),
    balance_before NUMERIC(26, 18),
    balance_after NUMERIC(26, 18),
    transaction_hash VARCHAR(66),
    block_number INTEGER,
    status VARCHAR DEFAULT 'PENDING',
    created_at TIMESTAMP DEFAULT NOW()
...
CREATE TABLE yield_statements (
    ...
    investor_id INTEGER REFERENCES investor_profiles(id) ON DELETE CASCADE,
    pool_id VARCHAR(50) REFERENCES pools(id) ON DELETE CASCADE,
    pool_position_id INTEGER,
    period_start TIMESTAMP NOT NULL,
    period_end TIMESTAMP NOT NULL,
    principal NUMERIC(26, 18) NOT NULL,
    shares_held NUMERIC(26, 18) NOT NULL,
    yield_earned NUMERIC(26, 18) NOT NULL,
    management_fee NUMERIC(26, 18) DEFAULT 0,
    performance_fee NUMERIC(26, 18) DEFAULT 0,
    net_yield NUMERIC(26, 18) NOT NULL,
    nav_start NUMERIC(26, 18) NOT NULL,
    nav_end NUMERIC(26, 18) NOT NULL,
...
CREATE TABLE gdiz_financings (
    ...
    approved_at TIMESTAMP,
    funded_at TIMESTAMP,
    application_doc VARCHAR(500),
    approval_doc VARCHAR(500),
...
-- =============================================================================
-- INSERT ALL DATA (100% match with local SQLite)
-- =============================================================================
...
INSERT INTO bank_accounts (account_id, investor_id, balance, currency, status, bank_name, account_number, iban, swift_code, created_at, updated_at, last_transaction_at, escrow_balance, available_balance, locked_amount, user_id) VALUES ('ESC-B7ABED3D', 1, 500000, 'EUR', 'ACTIVE', 'BIIC Bank', 'BJ3743882502', NULL, 'BIICBJBJ', '2026-04-02 16:07:22.682806', '2026-04-02 20:54:15.625773', NULL, 10000, 10000, 0, 1) ON CONFLICT DO NOTHING;
INSERT INTO bank_accounts (account_id, investor_id, balance, currency, status, bank_name, account_number, iban, swift_code, created_at, updated_at, last_transaction_at, escrow_balance, available_balance, locked_amount, user_id) VALUES ('ESC-B56EFCE6', 2, 0, 'EUR', 'ACTIVE', 'BIIC Bank', 'KE3396271357', NULL, 'BIICKENA', '2026-04-02 16:07:22.682813', '2026-04-02 20:54:15.631126', NULL, 50000, 50000, 0, 2) ON CONFLICT DO NOTHING;
INSERT INTO bank_accounts (account_id, investor_id, balance, currency, status, bank_name, account_number, iban, swift_code, created_at, updated_at, last_transaction_at, escrow_balance, available_balance, locked_amount, user_id) VALUES ('ESC-007-2026', 4, 0, 'EUR', 'ACTIVE', 'BIIC Bank', 'KE00000007', NULL, NULL, '2026-04-02 20:49:59.669165', '2026-04-02 20:54:15.632188', NULL, 2000000, 2000000, 0, 7) ON CONFLICT DO NOTHING;
INSERT INTO bank_accounts (account_id, investor_id, balance, currency, status, bank_name, account_number, iban, swift_code, created_at, updated_at, last_transaction_at, escrow_balance, available_balance, locked_amount, user_id) VALUES ('ESC-008-2026', 5, 0, 'EUR', 'ACTIVE', 'BIIC Bank', 'MU00000008', NULL, NULL, '2026-04-02 20:49:59.670724', '2026-04-02 20:54:15.632718', NULL, 3000000, 3000000, 0, 8) ON CONFLICT DO NOTHING;
INSERT INTO bank_accounts (account_id, investor_id, balance, currency, status, bank_name, account_number, iban, swift_code, created_at, updated_at, last_transaction_at, escrow_balance, available_balance, locked_amount, user_id) VALUES ('ESC-009-2026', 6, 0, 'EUR', 'ACTIVE', 'BIIC Bank', 'GB00000009', NULL, NULL, '2026-04-02 20:49:59.671546', '2026-04-02 20:54:15.633279', NULL, 5000000, 5000000, 0, 9) ON CONFLICT DO NOTHING;
INSERT INTO bank_accounts (account_id, investor_id, balance, currency, status, bank_name, account_number, iban, swift_code, created_at, updated_at, last_transaction_at, escrow_balance, available_balance, locked_amount, user_id) VALUES ('ESC-010-2026', 7, 0, 'EUR', 'ACTIVE', 'BIIC Bank', 'BJ00000010', NULL, NULL, '2026-04-02 20:49:59.672330', '2026-04-02 20:54:15.633799', NULL, 10000000, 10000000, 0, 10) ON CONFLICT DO NOTHING;
