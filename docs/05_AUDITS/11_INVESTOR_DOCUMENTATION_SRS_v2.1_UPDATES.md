...
- Bank escrow integration (BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB for production)
...
| **Q4 2026** | Production launch (BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB integration) | 🟡 Planned |
...
| **Bank Escrow** | BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB Mauritius (production) |
...
│  │  • BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB bank escrow                                  │  │
...
│  │  BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB Bank Escrow (Mauritius)                        │  │
...
- **Diversification:** Min 5 businesses per pool, max 10% per business
- **Insurance:** Property, business interruption
- **Bank Escrow:** BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB segregated accounts
...
**A:** Yes, via bank wire transfer to BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB escrow accounts (production only). MVP testnet uses mock fiat ramps.
...
**BIIC (Banque Internationale pour l'Industrie et le Commerce)/MCB Risks:**
