...
│  Nombre de tokens : 1 000 000 UPT       │
│                                         │
...
→ Elle reçoit 10 000 tokens UPT (10 000 × 1,00 €)
```
...
│                                         │
│  Nombre de tokens : 1 010 000 UPT       │
...
**Investisseuse : Fatima (possède 50 000 UPT)**
...
struct Certificate {
    ...
    uint256 value;            // Valeur en UJEUR (18 décimales)
    uint256 quantity;
...
| **Token UPT** | Token représentant une part dans le pool |
